...
export const aiSecurityChallenges: readonly Challenge[] = [
  buildChallenge({
    ...
    modeData: {
      multipleChoice: {
        question: "What is the most reliable mitigation against indirect prompt injection from documents?",
        options: [
          { id: "a", text: "Treat document text as untrusted; gate any model-driven action behind explicit user approval and limit tool permissions.", correct: true, rationale: "Defence in depth: don't let untrusted text grant capabilities." },
          { id: "b", text: "Tell the model not to follow instructions in the document.", correct: false, rationale: "Models do not reliably resist injection through instructions alone." },
          { id: "c", text: "Strip the word 'ignore' from documents.", correct: false, rationale: "Trivially bypassed." },
          { id: "d", text: "Use only longer system prompts.", correct: false, rationale: "Length doesn't outweigh injected text." },
        ],
      },
      explainPrompt:
  ...
  buildChallenge({
    ...
    modeData: {
      multipleChoice: {
        ...
        options: [
          { id: "a", text: "A single line in the system prompt asking the model to refuse.", correct: true, rationale: "Easily defeated; needs layered controls." },
          { id: "b", text: "Output classifiers checking for restricted content.", correct: false, rationale: "An effective layer." },
          { id: "c", text: "Fine-tuning with refusal data.", correct: false, rationale: "Strengthens default behaviour." },
          { id: "d", text: "Architectural isolation of risky tools.", correct: false, rationale: "Strong, makes some attacks impossible." },
        ],
      },
    },
  }),
